...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardGoal.setOnClickListener(v -> {
            Intent i = new Intent(DashboardActivity.this, GoalActivity.class);
            startActivity(i);
        });

        cardAsset.setOnClickListener(v -> {
            startActivity(new Intent(DashboardActivity.this, AssetsActivity.class));
        });

        cardLiability.setOnClickListener(v -> {
